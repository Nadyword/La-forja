          ...
          <div className="relative">
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white">
                ...
                <p className="text-sm text-white/80">Nuestros condominios confían en nosotros</p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="mt-10 flex flex-row gap-4">
              <Button
                size="lg"
                variant="outline"
                className="rounded-full px-8 border-primary/30 hover:bg-primary/10 bg-transparent flex items-center gap-2"
                asChild
              >
                <a
                  href="https://www.instagram.com/laforja.condominios/"
                  target="_blank"
              ...
              >
                <a
                  href="https://www.linkedin.com/company/tu_linkedin_empresa"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                >
